(() => {
            ...
            var je = function () {
                ...
                return e = t, i = [{
                    ...
                    value: function () {
                        var t = this,
                            e = {
                                play: "images/cs-player.svg",
                                pause: "images/cs-pause.svg"
                            },
                            i = {
                                expend: "images/cs-remove.svg",
                                close: "images/cs-remove.svg"
                            };
            ...
            var Ve = function () {
                ...
                }, 
                {
                    ...
                    value: function () {
                        ...
                        var loadingProgress = (this.processing.runWidth / 100) * 100;
                
                        // Calculate the percentage of the window loading progress
                        var windowLoadingProgress = (this.windowLoaded) ? 100 : 0;
                
                        // Increment the loading progress towards window loading progress
                        loadingProgress += 1; // Adjust the speed of the animation here (e.g., increment by 1%)
                        this.processing.runWidth = Math.min(loadingProgress, windowLoadingProgress);
                
                        // Update the inner width of this.DOM.text to match the loading progress
                        this.DOM.text.textContent = parseInt(this.processing.runWidth) + "%";
                        
                        // Ensure the text content remains visible
                        this.DOM.text.style.display = "block";
                
                        // Update the inner width of this.DOM.wrapInner to match the loading progress
                        this.DOM.text2.style.width = this.processing.runWidth + "%";
                
                        // Check if loading is complete
                        if (this.processing.runWidth >= 100 && this.registerCount === 0) {
                            // Set the loading progress and text content to 100%
                            this.processing.runWidth = 100;
                            this.DOM.text2.style.width = "100%";
                            this.DOM.text.textContent = "100%";
            ...
            var fi = function () {
                ...
                return e = t, i = [{
                    ...
                    value: function (t) {
                        var e = this,
                            i = new ui._;
                        return i.setDecoderPath("js/draco/"), this.loader.setDRACOLoader(i), new Promise((function (i) {
    ...
    var r = n.O(void 0, [736], (() => n('gsaapScrolling')));
    r = n.O(r)
})();